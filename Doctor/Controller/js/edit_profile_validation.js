function validateForm(){
    ...
    //chamber
    const chamber =document.getElementById("chamber").value.trim();
    if(chamber ===""){
        errors.push("chamber is required");
        document.getElementById("chamberErr").innerHTML="chamber is required";
    }else if(chamber.length <10){
        errors.push("chamber must be at least 10 characters");
        document.getElementById("chamberErr").innerHTML="chamber must be at least 10 characters";
    }
...
function clearErrors(){
    const errorIds=["phoneErr", "chamberErr", "currentPassErr", "newPassErr", "confirmPassErr"];
